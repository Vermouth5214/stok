...
Route::group(array('prefix' => 'backend','middleware'=> ['token_admin']), function()
{
	...
	Route::get('/media-library/trash','Backend\MediaLibraryController@trash');
    ...
    Route::get('/koreksi-stok-total','Backend\KoreksiController@koreksi_total');
    Route::post('/koreksi-stok-total','Backend\KoreksiController@koreksi_total_update');
