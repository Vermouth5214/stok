			...
			<div class="x_panel">
				<div class="x_content">
					{{ Form::open(['url' => $url, 'method' => $method,'class' => 'form-horizontal form-label-left']) }}
						...
						<div class="form-group">
							<label class="control-label col-sm-3 col-xs-12">Jenis Mobil</label>
							<div class="col-sm-9 col-xs-12">
								<textarea  name="jenis_mobil" class="form-control col-md-7 col-xs-12" rows=5><?=$jenis_mobil;?></textarea>
							</div>
                        </div>
						<div class="form-group">
