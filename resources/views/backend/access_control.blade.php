	...
	<div class="page-title">
		...
		<div class="title_right">
			<div class="col-md-4 col-sm-4 col-xs-8 form-group pull-right top_search">
				<a href="<?=url('/backend/modules/create');?>" class="btn-index btn btn-primary btn-block" title="Add"><i class="fa fa-plus"></i></a>
			</div>
		</div>
	</div>
									...
									<table class="table table-hover">
										...
										?>
											<tr>
												...
												<td>
													<input type="radio" name="access_<?=$data_module->id;?>" value="v" <?=$checked_v;?>>
												</td>
												<td>
													<input type="radio" name="access_<?=$data_module->id;?>" value="vu" <?=$checked_vu;?>>
												</td>
												<td>
													<input type="radio" name="access_<?=$data_module->id;?>" value="a" <?=$checked_a;?>>
												</td>
											</tr>
										<?php
											endforeach;
