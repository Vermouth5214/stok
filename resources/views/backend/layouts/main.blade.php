...
<html>
    <head>
        ...
        <title><?=$setting['web_title'];?> | Backend | @yield('title')</title>        
		<link rel="apple-touch-icon" href="<?=$setting['logo'];?>">
                ...
                <div class="col-md-3 left_col">
                    <div class="left_col scroll-view">
                        <div class="navbar nav_title" style="border: 0;">
                            <a href="<?=url('/backend')?>" class="site_title"><i class="fa fa-paw"></i> <span><?=$setting['company_name'];?></span></a>
                        </div>
